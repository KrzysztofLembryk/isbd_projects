...
fn main() {
    ...
    match matches.get_one::<String>("operation").map(String::as_str) {
        Some("GetQueries") => {
            let result = rt.block_on(client.get_queries(
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("GetSystemInfo") => {
            let result = rt.block_on(client.get_system_info(
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        /* Disabled because there's no example.
        Some("SubmitQuery") => {
            let result = rt.block_on(client.submit_query(
                  ???
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        */
        Some("GetQueryById") => {
            let result = rt.block_on(client.get_query_by_id(
                  "query_id_example".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("GetQueryError") => {
            let result = rt.block_on(client.get_query_error(
                  "query_id_example".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("GetQueryResult") => {
            let result = rt.block_on(client.get_query_result(
                  "query_id_example".to_string(),
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        ...
        */
        Some("GetTables") => {
            let result = rt.block_on(client.get_tables(
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("DeleteTable") => {
            let result = rt.block_on(client.delete_table(
                  "table_id_example".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("GetTableById") => {
            let result = rt.block_on(client.get_table_by_id(
                  "table_id_example".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
