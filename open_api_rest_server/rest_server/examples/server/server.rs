...
impl<C> Api<C> for Server<C> where C: Has<XSpanIdString> + Send + Sync
{
    ...
    {
        info!("get_queries() - X-Span-ID: {:?}", context.get().0.clone());
    ...
    {
        info!("get_system_info() - X-Span-ID: {:?}", context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("submit_query({:?}) - X-Span-ID: {:?}", execute_query_request, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_query_by_id(\"{}\") - X-Span-ID: {:?}", query_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_query_error(\"{}\") - X-Span-ID: {:?}", query_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_query_result(\"{}\", {:?}) - X-Span-ID: {:?}", query_id, get_query_result_request, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_table({:?}) - X-Span-ID: {:?}", table_schema, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_tables() - X-Span-ID: {:?}", context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_table(\"{}\") - X-Span-ID: {:?}", table_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_table_by_id(\"{}\") - X-Span-ID: {:?}", table_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
