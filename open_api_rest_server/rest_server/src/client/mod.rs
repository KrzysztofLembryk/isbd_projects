    ...
    B::Error: Into<Box<dyn Error + Send + Sync>>,
{
        ...
        context: &C) -> Result<GetQueriesResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = serde_json::from_str::<Vec<models::ShallowQuery>>(body)
        ...
        context: &C) -> Result<GetSystemInfoResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<models::SystemInformation>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;
    ...
    async fn submit_query(
        &self,
        param_execute_query_request: models::ExecuteQueryRequest,
        context: &C) -> Result<SubmitQueryResponse, ApiError>
    {
        ...
        // Consumes basic body
        // Body parameter
        let body = serde_json::to_string(&param_execute_query_request).expect("impossible to fail to serialize");
        *request.body_mut() = body_from_string(body);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(SubmitQueryResponse::QueryHasBeenCreatedSuccessfully
                    (body)
                )
            }
            400 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<models::MultipleProblemsError>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;


                Ok(SubmitQueryResponse::ResponseUsedWhenMoreProblemsCanOccurInTheSystemWhenProcessingRequest
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetQueryByIdResponse, ApiError>
    {
        ...
        let mut uri = format!(
            "{}/query/{query_id}",
            self.base_path
            ,query_id=utf8_percent_encode(&param_query_id.to_string(), ID_ENCODE_SET)
        );
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<models::Query>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;


                Ok(GetQueryByIdResponse::DetailedQueryDescription
                    (body)
                )
            }
            404 => {
                ...
                Ok(GetQueryByIdResponse::GenericError
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetQueryErrorResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetQueryErrorResponse::ResponseUsedWhenMoreProblemsCanOccurInTheSystemWhenProcessingRequest
                    (body)
                )
            }
            404 => {
                ...
                Ok(GetQueryErrorResponse::GenericError
                    (body)
                )
            }
            400 => {
                ...
                Ok(GetQueryErrorResponse::GenericError_2
                    (body)
                )
            }
            code => {
    ...
    async fn get_query_result(
        &self,
        param_query_id: String,
        param_get_query_result_request: Option<models::GetQueryResultRequest>,
        context: &C) -> Result<GetQueryResultResponse, ApiError>
    {
        ...
        // Consumes basic body
        // Body parameter
        if let Some(param_get_query_result_request) = param_get_query_result_request {
        let body = serde_json::to_string(&param_get_query_result_request).expect("impossible to fail to serialize");
        *request.body_mut() = body_from_string(body);
        }
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<Vec<models::QueryResultInner>>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;
            ...
            404 => {
                ...
                Ok(GetQueryResultResponse::GenericError
                    (body)
                )
            }
            400 => {
                ...
                Ok(GetQueryResultResponse::GenericError_2
                    (body)
                )
            }
            code => {
    ...
    async fn create_table(
        &self,
        param_table_schema: models::TableSchema,
        context: &C) -> Result<CreateTableResponse, ApiError>
    {
        ...
        // Consumes basic body
        // Body parameter
        let body = serde_json::to_string(&param_table_schema).expect("impossible to fail to serialize");
        *request.body_mut() = body_from_string(body);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(CreateTableResponse::TableCreatedSuccessfully
                    (body)
                )
            }
            400 => {
                ...
                Ok(CreateTableResponse::ResponseUsedWhenMoreProblemsCanOccurInTheSystemWhenProcessingRequest
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetTablesResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<Vec<models::ShallowTable>>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;
        ...
        context: &C) -> Result<DeleteTableResponse, ApiError>
    {
        ...
        let mut uri = format!(
            "{}/table/{table_id}",
            self.base_path
            ,table_id=utf8_percent_encode(&param_table_id.to_string(), ID_ENCODE_SET)
        );
        ...
        match response.status().as_u16() {
            ...
            404 => {
                ...
                Ok(DeleteTableResponse::GenericError
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetTableByIdResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<models::TableSchema>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;


                Ok(GetTableByIdResponse::DetailedTableDescription
                    (body)
                )
            }
            404 => {
                ...
                Ok(GetTableByIdResponse::GenericError
                    (body)
                )
            }
            code => {
